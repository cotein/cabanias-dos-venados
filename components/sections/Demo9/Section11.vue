<template>
    <section id="lnk-3" class="pt-100 ws-wrapper content-section">
        <div class="container">
            <div class="bc-5-wrapper bg--black-400 pattern-04 hidd bg--scroll r-16">
                <div class="section-overlay">
                    <!-- SECTION TITLE -->
                    <div class="row justify-content-center">
                        <div class="col-md-11 col-lg-9">
                            <div class="section-title color--white wow fadeInUp mb-60">
                                <!-- Title -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col">
                            <div class="bc-5-img bc-5-tablet img-block-hidden video-preview wow fadeInUp">
                                ...
                                <!-- Preview Image -->
                                <img class="img-fluid" src="/assets/images/tablet-05.png" alt="content-image" />
                            </div>
                        </div>
                    </div>
                </div>
