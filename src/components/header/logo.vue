<template>
    <div class="wsmobileheader clearfix">
        ...
        <NuxtLink to="/" class="logo-black"><span class="smllogo"><img src="/assets/images/logo.png" alt="mobile-logo" /></span></NuxtLink>
        <NuxtLink to="/" class="logo-white"><span class="smllogo"><img src="/assets/images/logo.png" alt="logo" /></span></NuxtLink>
